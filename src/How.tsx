        ...
        <div className="h-full w-full md:w-3/4 flex flex-col gap-6 place-self-center">
          <div className="p-2 md:px-16 flex flex-col gap-2 md:gap-6 items-center">
            ...
            <p className="text-gray-600 md:w-4/5 flex text-center">
              Explore and discover Non-Fungible Tokens (NFTs) like never before!
              Our platform offers a unique feature that allows you to easily
              view and track NFTs of any given address on the blockchain.
            </p>
          </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="bg-violet-200 rounded-xl p-2 md:w-1/2">
                ...
                <p className="text-gray-600">
                  Paste your Ethereum contract address to display all the list
                  NFT collection associated the wallet.
                </p>
              </div>
